...
<asp:Content ID="Content1" ContentPlaceHolderID="contentPlaceHolder" Runat="Server">
  ...
  <asp:GridView ID="grid" runat="server" AutoGenerateColumns="False" DataKeyNames="ProductID" Width="100%" BorderWidth="0px" OnRowDeleting="grid_RowDeleting" OnSelectedIndexChanged="grid_SelectedIndexChanged" ForeColor="#660033">
    <Columns>
      ...
      <asp:TemplateField HeaderText="Quantity">
        <ItemTemplate>
          <asp:TextBox ID="editQuantity" runat="server" CssClass="GridEditingRow" Width="38px" MaxLength="2" Text='<%#Eval("Quantity")%>' Font-Size="Smaller" />
        </ItemTemplate>
      </asp:TemplateField>
