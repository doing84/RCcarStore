<%@ Page Title="" Language="C#" MasterPageFile="~/BalloonShop.master" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="Users_Register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlaceHolder" Runat="Server">
    <table summary="User Registration application" style="width:auto">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="City" runat="server" ValidationGroup="member_join" OnSelectedIndexChanged="City_SelectedIndexChanged">
       ...
       <tr>
        ...
        <tr>
            ...
            <td>
                <p><asp:TextBox ID="cell_phone1" runat="server" Height ="37px" Width="125px" MaxLength="4" ValidationGroup="member_join"></asp:TextBox> - 
                <asp:TextBox ID="cell_phone2" runat="server" Height ="37px" Width="125px" MaxLength="4" ValidationGroup="member_join"></asp:TextBox> - 
                <asp:TextBox ID="cell_phone3" runat="server" Height ="37px" Width="125px" MaxLength="4" ValidationGroup="member_join"></asp:TextBox></p>
    ...
    <tfoot>
        <tr>
            <td colspan="2" style="text-align:center;">
                <asp:Button ID="submit" runat="server" Text="Save" onclick="submit_Click" OnClientClick="if (!submit_Click()) return false;" ValidationGroup="member_join" Width="68px" />
